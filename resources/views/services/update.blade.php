                        ...
                        <div class="card-body">
                           ...
                           <div class="row">
                               <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            {{-- <label for="exampleFormControlInput1">Email address</label> --}}
                                             <input type="type" class="form-control" id="title" name="title" placeholder="{{__('Title')}}" value={{old('title',$product->title)}} required>
                                          </div>
                                         </div>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group">
                                        <textarea name="description" id="description" rows="5" placeholder="{{__('Description')}}" > {{old('description',$service->description)}}</textarea>
                                          </div>
                                    </div>
