...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <meta content='width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0, shrink-to-fit=no' name='viewport' />
        ...
        <!-- CSS Files -->
        <link href="{{ asset('assets')}}/css/material-dashboard.min.css?v=2.1.1" rel="stylesheet">
        <!-- Documentation extras -->
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/docsearch.js/2/docsearch.min.css">
        <link rel="stylesheet" href="{{ asset('assets')}}/demo/docs.min.css">
        <style>
...
{{--        <script src="{{ asset('material') }}/js/settings.js"></script>--}}
        ...
        <!-- Vector Map plugin, full documentation here: http://jvectormap.com/documentation/ -->
        <script src="{{ asset('assets')}}/js/plugins/jquery-jvectormap.js"></script><style>
            #ofBar {
                background: #de2e2e;
                text-align: left;
                min-height: 60px;
        ...
        <!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages etc -->
        <script src="{{ asset('assets')}}/js/material-dashboard.min.js?v=2.1.1" type="text/javascript">
