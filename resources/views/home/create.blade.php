...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                <form action="{{route('homesstore')}}" method="post" enctype="multipart/form-data">
                    @csrf
                        <div class="card">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                {{-- <label for="exampleFormControlInput1">Email address</label> --}}
                                                 <input type="caption" class="form-control" id="caption" name="caption" placeholder="{{__('Caption')}}" required/>
                                              </div>
                                             </div>
